...
var initialLocation = [
...

  {
    ...
    directionsInfo:
      "The Belmont-Paul Women's Equality NM is located on Capitol Hill at the corner of Constitution Avenue and 2nd Street, NE, next to the Hart Senate Office building. It is a free-standing, federal style brick house surrounded by a black cast-iron fence.\nThe entrance for museum tours and the museum shop is located on 2nd Street with the lift accessible entrance located to the side of the museum next to the Hart Senate Office Building. The doors facing Constitution Avenue are not entrances.",
    ...
    $.ajax({
      ...
      success: function(response) {
        ...
        contentString +=
          ...
          url +
          '"><i class="fa fa-wikipedia-w" aria-hidden="true"></i>  Wikipedia</a>&nbsp;&nbsp;<a class="btn btn-success btn-sm" href="' +
          location.marker.directionsUrl +
          '"><i class="fa fa-map-pin" aria-hidden="true"></i>  Visit</a></div>';
